...
현재 `bundled-assets-v1`과 K01·K02·K03이 포함된 `cat-packs-v1`은 게시됐고, 새 clone의 bootstrap·테스트·빌드·ad-hoc 서명 검증을 통과했습니다. Developer ID 서명, notarization, 앱 버전 태그는 아직 남아 있습니다.
